...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 8px 12px; border-radius: 4px; text-decoration: none; font-size: 14px; border: none; cursor: pointer; margin: 0 2px; color: white !important; }
        .btn-add { background-color: #28a745; float: right; margin-bottom: 20px; }
